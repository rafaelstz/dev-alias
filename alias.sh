...
alias install-modgit="cd $base;mkdir tools; cd tools;wget -O modgit https://raw.github.com/jreinke/modgit/master/modgit; chmod +x modgit; mv modgit /usr/local/bin;clear;echo READY =];cd ~/"
